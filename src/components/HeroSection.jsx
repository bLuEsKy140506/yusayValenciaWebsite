...
const HeroSection = () => {
  return (
    <section
      id="hero"
      className="relative flex items-center px-6 md:px-12 lg:px-20 py-20 md:py-24 lg:py-28 min-h-screen bg-cover bg-center overflow-hidden"
    ...
    >
      ...
      <div className="absolute -top-24 -left-20 h-64 w-64 rounded-full bg-green-300/30 blur-3xl" />
      ...
      <div className="relative z-10 flex flex-col-reverse md:flex-row items-center justify-between w-full gap-10 md:gap-12 lg:gap-16 max-w-7xl mx-auto [@media(max-height:750px)]:gap-5">
        ...
        <div className="w-full md:w-1/2 flex justify-center md:justify-end">
          <div className="rounded-3xl shadow-2xl text-center p-10 sm:p-12 md:p-14 lg:p-16 w-full max-w-sm sm:max-w-md md:max-w-lg bg-gradient-to-b from-[#2c7a47] to-[#1d5b31] text-white ring-1 ring-white/30 backdrop-blur-sm">
            <h2 className="text-5xl sm:text-6xl md:text-7xl font-extrabold">60+</h2>
            <p className="text-lg sm:text-xl md:text-2xl font-medium">Years of Trusted Service</p>
